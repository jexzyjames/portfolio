  ...
  return (
    <div className='services'>
        ...
        {/* <motion.div */}
         {/* initial={{ opacity: 0, translateY: -100 }}
        whileInView={{ opacity: 1, translateY: 0, transition:{delay: 0.5} }}
        whileFocus={{ opacity: 1, translateY: 0, transition:{delay:0.5} }} className="services-container"> */}
            {data.map((item,id) =>{
                return(
                ...
                <img src={item.w_img} alt="" /> 
                    <motion.div
                      ...
                      whileInView={{ opacity: 1, translateX: 0, transition:{delay: 0.7} }}
                      whileFocus={{ opacity: 1, translatX: 0, transition:{delay:0.7} }} 
                    className="deeds">
                        <motion.div
                         initial={{ opacity: 0, translateX: 100 }}
                         whileInView={{ opacity: 1, translateX: 0, transition:{delay: 0.7} }}
                         whileFocus={{ opacity: 1, translateYX: 0, transition:{delay:0.7} }} 
                         className="write-up">
                            <p>{item.text}</p>
                            <ul>
